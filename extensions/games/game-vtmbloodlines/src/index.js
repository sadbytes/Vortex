...
function prepareForModding(discovery) {
  return Promise.all(
    ["Vampire", "Unofficial_Patch"].map((modPath) =>
      fs.ensureDirWritableAsync(path.join(discovery.path, modPath)),
    ),
  );
}
...
function main(context) {
  ...
  context.registerModType(
    ...
    () => getUnofficialModPath(context.api),
