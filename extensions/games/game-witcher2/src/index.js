...
function main(context) {
  ...
  context.registerGame({
    ...
    logo: "gameart.jpg",
    executable: win32 ? () => "bin/witcher2.exe" : () => "launcher",
    setup: prepareForModding,
    requiredFiles: win32
      ? ["bin/witcher2.exe", "bin/userContentManager.exe"]
      : ["launcher", "saferun.sh", "tenfoot-launcher", "desktop-launcher"],
    details: {
      steamAppId: 20920,
    },
  });
