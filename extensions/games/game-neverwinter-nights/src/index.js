      ...
      actions: [
        {
          ...
          action: () => {
            context.api.showDialog(
              ...
              {
                text:
                  'Vortex has detected multiple "viable" Neverwinter Nights mod paths on your system:\n\n' +
                  "{{modPaths}}\n\n" +
...
function main(context) {
  ...
  context.registerGame({
    ...
    requiredFiles: ["bin/win32/nwmain.exe"],
    environment: {
      SteamAPPId: "704450",
    },
    details: {
