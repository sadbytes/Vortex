...
let tools = [
  ...
  },
  {
    ...
    requiredFiles: ["f4se_loader.exe", "Fallout4.exe"],
    relative: true,
    exclusive: true,
    defaultPrimary: true,
  },
...
function main(context) {
  context.registerGame({
    ...
    queryArgs: {
      ...
      registry: [
        {
          id: "HKEY_LOCAL_MACHINE:Software\\Wow6432Node\\Bethesda Softworks\\Fallout4:Installed Path",
        },
      ],
    },
    ...
    details: {
      ...
      hashFiles: ["appxmanifest.xml", "Data/Fallout4.esm"],
    },
  });
